...
const orderStatusData = [
  {
    name: "Pending",
    value: pendingCount[0].total,
  },
  {
    name: "Processing",
    value: processingCount[0].total,
  },
  {
    name: "Shipped",
    value: shippedCount[0].total,
  },
  {
    name: "Delivered",
    value: deliveredCount[0].total,
  },
  {
    name: "Cancelled",
    value: cancelledCount[0].total,
  },
];
...
const growth =
  ...
  <Link
    href="/admin/reports"
    className="bg-orange-600 text-white p-5 rounded-xl text-center font-bold"
  >
  ...
  <Link
  href="/admin/reviews"
  className="bg-red-600 text-white p-5 rounded-xl text-center font-bold"
>
  Reviews
</Link>
<Link
  href="/admin/inventory"
  className="bg-cyan-600 text-white p-5 rounded-xl text-center font-bold"
>
  Inventory
</Link>
...
<div className="bg-white p-6 rounded-xl shadow mt-8">
        ...
        <div className="grid md:grid-cols-5 gap-4">
          ...
          <div className="bg-blue-100 p-4 rounded">
            Processing: {processingCount[0].total}
          </div>
          <div className="bg-purple-100 p-4 rounded">
            Shipped: {shippedCount[0].total}
          </div>
          <div className="bg-green-100 p-4 rounded">
            Delivered: {deliveredCount[0].total}
          </div>
          <div className="bg-red-100 p-4 rounded">
            Cancelled: {cancelledCount[0].total}
          </div>
        </div>
      </div>
      <div className="bg-white p-6 rounded-xl shadow mt-8">
